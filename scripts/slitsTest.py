...
# The motor will need to take gradient conditions at given positions and map them to motor locations.
# The motor locations will then need to 

np.savetxt("listOfPositions.csv", gradientPositions, delimiter=",")
np.savetxt("listOfGradients.csv", gradientPositions, delimiter=",")